...
public class ListViewAdapter2 extends BaseAdapter implements Filterable {
    ...
    private ArrayList<ListViewItem2> filteredItemList2 = listViewItemList2 ;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ListViewItem2 listViewItem2 = filteredItemList2.get(position);

        // 아이템 내 각 위젯에 데이터 반영
        iconImageView2.setImageDrawable(listViewItem2.getIcon());
        titleTextView2.setText(listViewItem2.getTitle());
        descTextView2.setText(listViewItem2.getDesc());
    ...
    private class ListFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0) {
                ...
                for (ListViewItem2 item : listViewItemList2) {
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            ...
            filteredItemList2 = (ArrayList<ListViewItem2>) results.values ;
